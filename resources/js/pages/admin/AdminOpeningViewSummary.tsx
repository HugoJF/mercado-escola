...
export const AdminOpeningViewSummary: React.FC<AdminOpeningViewSummary> = ({opening}) => {
    return <div className="px-6 py-4 space-y-6">
        <div className="flex items-center space-x-4">
            <Calendar className="text-gray-400"/>
            <div className="space-y-1">
                <h2 className="text-gray-700 text-xl">Data de abertura</h2>
        ...
        <div className="flex items-center space-x-4">
            <Calendar className="text-gray-400"/>
            <div className="space-y-1">
                <h2 className="text-gray-700 text-xl">Data de fechamento</h2>
        ...
        <div className="flex items-center space-x-4">
            <Calendar className="text-gray-400"/>
            <div className="space-y-1">
                <h2 className="text-gray-700 text-xl">Data de entrega</h2>
