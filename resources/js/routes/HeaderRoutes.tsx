...
export const HeaderRoutes: React.FC = () => {
    return <Switch>
        ...
        <Route exact path="/conta" children={null}/>
        <Route exact path="/admin" children={null}/>
        <Route exact path="/favoritos" children={null}/>
        <Route exact path="/pedidos" children={null}/>
